...
export const b2cPolicies = {
    ...
    authorities: {
        signUpSignIn: {
            authority: 'https://bcmsdevorg.b2clogin.com/bcmsdevorg.onmicrosoft.com/B2C_1_SignInAndSignUp',
        },
        forgotPassword: {
...
//https://bcmstestorg.b2clogin.com/bcmstestorg.onmicrosoft.com/v2.0/.well-known/openid-configuration?p=B2C_1_MyAPIMProjectB2C
